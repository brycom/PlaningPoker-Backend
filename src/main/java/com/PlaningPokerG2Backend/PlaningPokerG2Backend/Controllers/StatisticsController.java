...
public class StatisticsController {
    ...
    public double getAverageVoteForIssue(@PathVariable UUID issueId) {
        return statisticsService.getAverageVoteForIssue(issueId);
    }

    @GetMapping("/issuesWithHighVotes/{projectId}/{threshold}")
    public List<Issues> getIssuesWithHighVotes(@PathVariable String projectId, @PathVariable float threshold) {
