...
public class StatisticsService {
    ...
    public double getAverageVoteForIssue(String issueId) {
        Issue issue = issuesService.getIssueById(issueId);
        if (issue != null) {
    ...
    public List<Issue> getIssuesWithVotesAboveThreshold(String projectId, float threshold) {
        Project project = projectService.getProjectById(projectId);
        if (project != null) {
